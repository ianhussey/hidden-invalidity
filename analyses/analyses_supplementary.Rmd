...
I.e., Correlations between latent and observed scores, and misclassification rate between them
...
# write to disk
write_csv(latent_observed_correlation_results, "results/latent_observed_correlations.csv")
...
THESE SHOULD BE FIT TO THE FULLY CONSTRAINED MI MODELS
...
# write to disk
write_csv(group_differences_results, "results/group_differences_on_latent_vs_observed.csv")
