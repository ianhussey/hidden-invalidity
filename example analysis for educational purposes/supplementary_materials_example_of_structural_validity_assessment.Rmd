...
# write to disk
write_csv(latent_observed_correlation_results, "results/effect_sizes_cfa_fits.csv")
...
# write to disk
write_csv(group_differences_results, "results/effect_sizes_measurement_invariance.csv")
