...
load("~/git/Attitudes-2.0/data/subsets/attitudes_2.0_subset_exploratory.RData")

# trim data 
#trimmed_data <- attitudes_2.0_data %>%
trimmed_data <- attitudes_2.0_subset_exploratory %>%
...
# save to disk
save(trimmed_data, file = "processed/trimmed_data.RData")
